...
document.getElementById("insider-form").addEventListener("submit", function(event) {
    ...
    var insiderRef = database.ref("insider-info").push();
    insiderRef.set({
        name: name,
        email: email,
        message: message
    ...
    .then(function() {
        ...
        document.getElementById("insider-form").reset();
    ...
    .catch(function(error) {
        // Handle errors
        console.error("Error submitting insider information:", error);
